...
//------------------------------------------------------------------------------------//
let baseMap = 'https://cartodb-basemaps-{s}.global.ssl.fastly.net/dark_all/{z}/{x}/{y}.png';
let colorMap = 'http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';

let darkMap = L.tileLayer('http://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}.png', {
  attribution: 'Maps © <a href=\"www.openstreetmap.org/copyright\">OpenStreetMap</a> contributors - Dark matter',
  minZoom: 5,
  maxZoom: 8,
})

let layer = new L.TileLayer(colorMap, {
...
let animateFlightsBtn = L.easyButton({
  states: [{
...
let newengland2 = 'https://opensky-network.org/api/states/all?lamin=39.560217&lomin=-80.740297&lamax=47.578931&lomax=-66.062839';
let usa = 'https://opensky-network.org/api/states/all?lamin=15.347286&lomin=-158.456221&lamax=45.746833&lomax=-49.561230';
let newengland= 'https://opensky-network.org/api/states/all?lamin=42.075743&lomin=-79.742226&lamax=47.261665&lomax=-67.515351';
...
let plane1 = L.icon({
    iconUrl: 'img/flight_icon_purple.png',
    iconSize:     [15, 15],
    iconAnchor:   [10, 10],
    popupAnchor: [0, -10],
    className: 'planeClass' 
...
function listFlights(a) {
  ...
  for(let i = 0; i < flights.states.length; i++) {
      ...
      title: "Flight: "+ flights.states[i][1] +" ", icon: planeIcon(flights.states[i][8]), rotationAngle: flights.states[i][10]
      }).addTo(map);
